...
#define I_USE_EVO_HELD_ITEMS_FROM_BAG   GEN_LATEST  // If TRUE, items such as Razor Claw or Electirizer will be usable from the bag to evolve a Pokémon just like in LA.
