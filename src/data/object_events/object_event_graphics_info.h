...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Brassius = {
    .tileTag = TAG_NONE, 
    .paletteTag = OBJ_EVENT_PAL_TAG_BRASSIUS, 
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE, 
    .size = 256, 
    .width = 16, 
    .height = 32,
