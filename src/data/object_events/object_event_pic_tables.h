...
static const struct SpriteFrameImage sPicTable_Rika[] = {
    ...
    overworld_frame(gObjectEventPic_Rika, 2, 4, 1),
    overworld_frame(gObjectEventPic_Rika, 2, 4, 2),
    overworld_frame(gObjectEventPic_Rika, 2, 4, 3),
    overworld_frame(gObjectEventPic_Rika, 2, 4, 4),
    overworld_frame(gObjectEventPic_Rika, 2, 4, 5),
    overworld_frame(gObjectEventPic_Rika, 2, 4, 6),
    overworld_frame(gObjectEventPic_Rika, 2, 4, 7),
