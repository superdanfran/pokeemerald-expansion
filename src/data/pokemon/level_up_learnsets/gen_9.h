...
static const struct LevelUpMove sGreninjaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(90, MOVE_NIGHT_DAZE),
    LEVEL_UP_END
};
...
static const struct LevelUpMove sMeowscaradaLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(75, MOVE_ALLY_SWITCH),
    LEVEL_UP_MOVE(80, MOVE_POLLEN_PUFF),
    LEVEL_UP_MOVE(82, MOVE_PLAY_ROUGH),
...
static const struct LevelUpMove sQuaquavalLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(82, MOVE_FLYING_PRESS),
    LEVEL_UP_MOVE(90, MOVE_WAVE_CRASH),
    LEVEL_UP_END
};
