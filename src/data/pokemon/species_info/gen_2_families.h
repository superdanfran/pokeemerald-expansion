...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_FERALIGATR_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "with a bite 10 times as powerful as\n"
            "Mega Feraligatr's actual jaws."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA},
                                {EVO_LEVEL, 52, SPECIES_URSALUNA_BLOODMOON}),
    },
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_SKARMORY_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "After whipping up shock waves to send\n"
            "enemies flying, it finishes them off with\n"
            "its talons."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 271,
