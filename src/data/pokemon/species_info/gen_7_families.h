...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        .abilities = { ABILITY_LONG_REACH, ABILITY_NONE, ABILITY_TINTED_LENS },
    ...
    [SPECIES_DECIDUEYE_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SCRAPPY, ABILITY_NONE, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Decidueye"),
        .cryId = CRY_DECIDUEYE,
        .natDexNum = NATIONAL_DEX_DECIDUEYE,
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        .abilities = { ABILITY_LIQUID_VOICE, ABILITY_NONE, ABILITY_BERSERK },
    ...
    [SPECIES_CUTIEFLY] =
    {
        ...
        .abilities = { ABILITY_DAZZLING, ABILITY_SHIELD_DUST, ABILITY_SWEET_VEIL },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_STEENEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_TSAREENA}),
    },
