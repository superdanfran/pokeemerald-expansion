...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_NYMBLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TINTED_LENS, ABILITY_ADAPTABILITY, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FIDOUGH] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_PIXILATE, ABILITY_KLUTZ },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DACHSBUN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_WELL_BAKED_BODY, ABILITY_PIXILATE, ABILITY_AROMA_VEIL },
    ...
    [SPECIES_SMOLIV] =
    {
        ...
        .abilities = { ABILITY_HARVEST, ABILITY_TRIAGE, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_DOLLIV] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_ARBOLIVA}),
    },
