...
#define BEEDRILL_ATTACK (P_UPDATED_STATS >= GEN_6 ? 90 : 80)
    ...
    [SPECIES_BEEDRILL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LEVITATE, ABILITY_SNIPER, ABILITY_MERCILESS },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_FEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SNIPER, ABILITY_SCRAPPY, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_BROWN,
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_SANDSHREW_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STURDY, ABILITY_BATTLE_ARMOR, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Sandshrew"),
        .cryId = CRY_SANDSHREW,
        .natDexNum = NATIONAL_DEX_SANDSHREW,
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_VICTREEBEL_MEGA] =
    {
        ...
        .weight = 155,
        .description = COMPOUND_STRING(
            "The volume of this Pokémon's acid has\n"
            "increased due to Mega Evolution, filling\n"
            "its mouth. If it's not careful, the acid\n"
            "will overflow and spill out."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 312,
        .trainerOffset = 3,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_STARMIE_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "humanlike. Whether it's simply trying\n"
            "to communicate or wants to supplant\n"
            "humanity is unclear."),
        .pokemonScale = 301,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_DRAGONITE_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "up this Pokémon's feelings of kindness.\n"
            "It finishes off its opponents with mercy\n"
            "in its heart."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 309,
